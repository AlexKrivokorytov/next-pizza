...
import { useIngredients, useFilters, useQueryFilters, ReturnProps } from '../../hooks';
  ...
  if (activeCategoryId === 3) {
    return (
      <CheckboxFiltersGroup
        ...
        selected={filters.sizes}
        items={[
          { text: '6 pieces', value: '6' },
          { text: '9 pieces', value: '9' },
          { text: '12 pieces', value: '12' },
        ]}
      />
    );
  }
  ...
  if (activeCategoryId === 4) {
    return (
      <CheckboxFiltersGroup
        ...
        selected={filters.sizes}
        items={[
          { text: '300 ml', value: '300' },
          { text: '500 ml', value: '500' },
        ]}
      />
    );
  }
...
const PriceRangeFilter = ({ filters, isDarkPurple }: { filters: ReturnProps; isDarkPurple: boolean }) => {
  ...
  return (
    <div className={cn('mt-5 border-y py-6 pb-7', isDarkPurple ? 'border-y-gray-700' : 'border-y-orange-200')}>
