...
export const products = [
  {
    ...
    imageUrl: '/products/omelet with ham and mushrooms.png',
    categoryId: 2,
  },
  {
    name: 'Omelet with pepperoni',
    imageUrl: 'public/products/omelet with pepperoni.webp',
    categoryId: 2,
  },
  {
    name: 'Coffee Latte',
    imageUrl: 'public/products/coffee latte.webp',
    categoryId: 2,
  },
  {
    name: 'Denwich ham and cheese',
    imageUrl: 'public/products/denwich ham and cheese.webp',
    categoryId: 3,
  },
  {
    name: 'Chicken nuggets',
    imageUrl: 'public/products/chicken nuggets.avif',
    categoryId: 3,
  },
  {
    name: 'Baked potatoes with sauce 🌱',
    imageUrl: 'public/products/baked potatoes.webp',
    categoryId: 3,
  },
  {
    name: 'Dodster',
    imageUrl: 'public/products/dodster.webp',
    categoryId: 3,
  },
  {
    name: 'Spicy Dodster 🌶️🌶️',
    imageUrl: 'public/products/spicy dodster.webp',
    categoryId: 3,
  },
  {
    name: 'Banana milkshake',
    imageUrl: 'public/products/banana milkshake.webp',
    categoryId: 4,
  },
  {
    name: 'Caramel apple milkshake',
    imageUrl: 'public/products/caramel apple milkshake.webp',
    categoryId: 4,
  },
  {
    name: 'Oreo milkshake',
    imageUrl: 'public/products/oreo milkshake.webp',
    categoryId: 4,
  },
  {
    name: 'Classic milkshake 👶',
    imageUrl: 'public/products/classic milkshake.webp',
    categoryId: 4,
  },
  {
    name: 'Irish cappuccino',
    imageUrl: 'public/products/irish cappuchino.avif',
    categoryId: 5,
  },
  {
    name: 'Caramel cappuccino',
    imageUrl: 'public/products/caramel cappuchino.webp',
    categoryId: 5,
  },
  {
    name: 'Coconut latte',
    imageUrl: 'public/products/coconut latte.webp',
    categoryId: 5,
  },
  {
    name: 'Americano coffee',
    imageUrl: 'public/products/americano coffe.webp',
    categoryId: 5,
  },
  {
    name: 'Coffee Latte',
